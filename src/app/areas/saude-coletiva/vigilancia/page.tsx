...
import Content, { metadata as frontmatter } from "@/content/areas/saude-coletiva/vigilancia.mdx";

const PATH = "/areas/saude-coletiva/vigilancia";
const CRUMBS = [
  { label: "Início", href: "/" },
...
export default function AreasSaudeColetivaVigilanciaPage() {
  return (
    <PilarTemplate
      path={PATH}
      crumbs={CRUMBS}
