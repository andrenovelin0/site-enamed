...
import Content, { metadata as frontmatter } from "@/content/areas/cirurgia/cirurgia-vascular.mdx";

const PATH = "/areas/cirurgia/cirurgia-vascular";
const CRUMBS = [
  { label: "Início", href: "/" },
...
export default function AreasCirurgiaVascularPage() {
  return (
    <PilarTemplate
      path={PATH}
      crumbs={CRUMBS}
