      ...
      <div className="container-page py-14">
        <div className="grid grid-cols-2 gap-8 sm:grid-cols-3 lg:grid-cols-5">
          <div className="col-span-2 lg:col-span-1">
            ...
            <p className="mt-4 text-sm text-brand-100/70 max-w-xs leading-relaxed">
              Portal de referência sobre o Exame Nacional de Avaliação da Formação Médica:
              guias, simulados e cursos preparatórios.
            </p>
          </div>
        ...
        <div className="mt-12 pt-6 border-t border-white/10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          <p className="text-xs text-brand-100/60">
            © {year} ENAMED. Todos os direitos reservados.
          </p>
          <p className="text-xs text-brand-100/60">
